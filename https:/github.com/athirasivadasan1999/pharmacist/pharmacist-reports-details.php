...
<head>
  ...
  <title>
    Pharmacy Management System - Sold Report
  </title>
...
$pname=$row['FullName'];
?>
<h4 align="center" style="color:blue">Report from <?php echo $fdate?> to <?php echo $tdate?>  <?php echo $pname?></h4>
...
$ret=mysqli_query($con,"Select tblmedicine.MedicineName,tblmedicine.MedicineBatchno,sum(tblcart.ProductQty) as ProductQty,tblmedicine.Priceperunit
 ...
 where date(tblcart.CartDate) between '$fdate' and '$tdate' and tblcart.PharmacistId='$pid' 
