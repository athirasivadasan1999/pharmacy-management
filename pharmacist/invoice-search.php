...
$ret=mysqli_query($con,"select distinct tblcustomer.BillingNumber,tblcustomer.CustomerName,tblcustomer.MobileNumber,tblcustomer.ModeofPayment,tblcustomer.BillingDate from tblcart join tblcustomer on tblcustomer.BillingNumber=tblcart.BillingId where  tblcart.PharmacistId='$pmspid' and (tblcustomer.BillingNumber='$sdata' || tblcustomer.MobileNumber='$sdata') ");
