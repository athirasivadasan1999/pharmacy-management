...
$ret=mysqli_query($con,"Select MedicineName,sum(tblcart.ProductQty) as selledqty,tblmedicine.* from tblmedicine   left join tblcart  on tblmedicine.ID=tblcart.ProductId group by MedicineName");
