...
<head>
  ...
  <title>
    Pharmacy Management System - Pharmacist Login Page
  </title>
  ...
  <div class="main-content">
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <p class="text-lead text-light">Pharmacist Login</p>
            </div>
          </div>
        </div>
      </div>
    ...
    echo $msg;
                ...
                <div class="text-center">
                  <button class="btn btn-primary my-4" type="submit" name="login">Sign in</button>
                </div>
              </form>
            </div>
          </div>
