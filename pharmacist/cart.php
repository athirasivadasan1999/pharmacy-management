  ...
  <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="mobilenumber" name="mobilenumber" class="form-control form-control-alternative" required="true" maxlength="10" minlength="10"pattern="[0-9]+" style="border:1px #000 solid;">
                      </div>
                    </div>
