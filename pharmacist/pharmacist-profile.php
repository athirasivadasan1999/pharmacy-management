...
<head>
  ...
  <title>
     Pharmacy Management System - Pharmacist Profile
  </title>
...
?>              
                ...
                <h6 class="heading-small text-muted mb-4">Update Your Profile</h6>
                <div class="pl-lg-12">
                  <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="mobnumber" name="mobnumber"class="form-control form-control-alternative" value="<?php  echo $row['MobileNumber'];?>" required="true" maxlength="10" minlength="10" pattern="[0-9]+" style="border:1px #000 solid;">
                      </div>
                    </div>
                     <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">User Name</label>
                        <input type="text" id="username" name="username" class="form-control form-control-alternative" value="<?php  echo $row['UserName'];?>" required="true" readonly='true' style="border:1px #000 solid;">
                      </div>
                    </div>
