                    ...
                    <div class="col-lg-12">
                     ...
                     <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="contactnumber" name="contactnumber" class="form-control form-control-alternative" value="" required="true" maxlength="10" pattern="[0-9]+"<?php  echo $row['MobileNumber'];?>" style="border:1px #000 solid;">
                      </div>
                    </div>
                    <div class="col-lg-12">
                      <div class="form-group">
