                    ...
                    <div class="col-lg-12">
                     ...
                     <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="quantity" name="quantity" class="form-control form-control-alternative" value="" required="true" style="border:1px #000 solid;" >
                      </div>
                    </div>
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">Price per Units</label>
                        <input type="text" id="price" name="price" class="form-control form-control-alternative" value="" required="true" style="border:1px #000 solid;" >
                      </div>
                    </div>
